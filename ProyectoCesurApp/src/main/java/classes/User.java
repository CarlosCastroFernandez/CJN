...
public class User {
      ...
      */
     public User(Integer id, String name, String lastName, String lastName2,
      ...
      */
     public void setName(String name) throws NameWithNumber {
          String numbers="0123456789";
          for(int i=0;i<name.length();i++) {
               if(numbers.contains(""+name.charAt(i))) {
                    throw new NameWithNumber("El nombre no puede contener números");
               }
          }
          this.name = name;
     }
      ...
      */
     public void setLastName(String lastName) throws LastNameWithNumber {
          String numbers="0123456789";
          for(int i=0;i<lastName.length();i++) {
               if(numbers.contains(""+lastName.charAt(i))) {
                    throw new LastNameWithNumber("El apellido no puede contener números");
               }
          }
          this.lastName = lastName;
     }
      ...
      * @throws LastNameWithNumber Si el apellido contiene números.
      */
     public void setLastName2(String lastName2) throws LastNameWithNumber {
          String numbers="0123456789";
     ...
     public void setDni(String dni) throws InvalidDNI {
          ...
          for(byte i=0;i<dni.length();i++) {
               if(!letters.contains(""+dni.charAt(i))&&dni.length()-1>i) {
                    ...
                    throw new InvalidDNI("El dni es invalido");
               }
          }
     }
